...
def build_report(summary: str, tree: str, git: dict[str, str | None]) -> str:
    ...
    lines.extend(
        [
            ...
            "-" * 80,
            "  1. Connection-type validation (isValidConnection) between handles",
            "  2. Implement backend topological sort + report which edge cycles",
            "  3. Add unit tests for parseTextVariables / DAG edge cases",
            "  4. Optional: backend execution stub for LangChain-style chains",
            "",
            "=" * 80,
